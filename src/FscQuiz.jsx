...
const QUESTIONS = [
  {
    i: 1,
    q: "Which of the following statements are correct when creating Financial Goals?",
    o: [
  ...
  {
    i: 2,
    q: "A Salesforce Admin is configuring a new Action Plan Template. One task in that template needs to be picked up by the next available Advisor. What assignment logic should the Admin use when configuring this template task?",
    o: [
  ...
  {
    i: 3,
    q: "Which three of these statements are true for Rollup By Lookup (RBL) in Financial Services Cloud?",
    o: [
  ...
  {
    i: 4,
    q: "During the delivery stage of a Financial Services Cloud (FSC) implementation, a consultant needs to think about how to utilize FSC-related objects. Which three things should the consultant consider when adopting such objects?",
    o: [
  ...
  {
    i: 5,
    q: "What actions can a Wealth Advisor take from the Life Events card7",
    o: [
      "A. Create Case",
  ...
  {
    i: 7,
    q: "Which two statements are true for a Group in Financial Services Cloud?",
    o: [
  ...
  {
    i: 8,
    q: "One administrator user at a financial services company needs to help management build reports and gain insights into business performance by including branch management reportable objects.\nWhich two considerations should the administrator include when configuring the report?",
    o: [
  ...
  {
    i: 9,
    q: "What is a key step in identifying different business processes and outlining encompassing system flows based on the existing environment when setting up Salesforce Financial Services Cloud (FSC)?",
    o: [
  ...
  {
    i: 10,
    q: "How should developers configure customized nodes for display in Actionable Relationship Center (ARC)?",
    o: [
      "A. Select Use Flex Card from the node Display tab to show the node in a Flex Car",
      "B. Reference the Lightning web component in the Display properties of the custom ARC relationship graph.",
      "C. Select Omni Script from the node Actions tab to show the node in an Omni Script.",
  ...
  {
    i: 11,
    q: "What does the Salesforce Admin have to install to provide users access to referral dashboards and reports?",
    o: [
  ...
  {
    i: 12,
    q: "What are two language-related limitations of Financial Services Cloud?",
    o: [
      "A. Predefined reciprocal roles are available only in English.",
  ...
  {
    i: 13,
    q: "Users at Lake Bank have been creating multiple events for once in a lifetime event such as birth. What should an Administrator do to prevent users from accidentally creating more than one event of such an event type?",
    o: [
  ...
  {
    i: 14,
    q: "A Financial Services Cloud (FSC) administrator is assigning permission set licenses to users, including personal bankers. Which permission set license is recommended for this set of users?",
    o: [
      "A. FSC Foundations permission set license",
      "B. FSC Basic permission set license",
      "C. FSC Extension permission set license",
      "D. FSC Standard permission set license",
    ],
    a: ["D"],
  },
  {
    i: 15,
    q: "Which two limitations should a Salesforce Administrator consider before enabling Person Accounts?",
    o: [
  ...
  {
    i: 16,
    q: "A Financial Services Cloud (FSC) administrator wants to create a new FSC permission set that includes the Access Interest Tags for Financial Services Cloud permission.\nWhich two permission sets should be cloned to create this new permission set and give access to interest tags?",
    o: [
  ...
  {
    i: 17,
    q: "The Salesforce Admin wants to make it easier for call center agents to complete some common tasks by setting up flow sand launch them from the Retail Banking Console. What does the Admin have to keep in mind when setting up Flows?",
    o: [
  ...
  {
    i: 18,
    q: "A financial services company wants to plan ahead for designing the Financial Services Cloud (FSC) implementation. Which three activities should the implementation team prioritize during planning?",
    o: [
  ...
  {
    i: 19,
    q: "How can the Salesforce Admin help agents who deal with a large number of customers on a daily basis, quickly scan the Life Events component and find the information they need without much effort?",
    o: [
  ...
  {
    i: 20,
    q: "A system administrator at a financial services company wants to build a report to show Interest Tags.\nWhich two things should the administrator consider when configuring the report?",
    o: [
      "A. When the user defines the custom report type, Tag Categories should be selected as the Primary Object.",
      "B. When the user defines the custom report type, Topics should be selected as the Primary Object.",
      "C. The user must build a report using the Topics object to view Interest Tags in the report.",
  ...
  {
    i: 21,
    q: "What step is required to give users access to the Financial Services Cloud Commercial Banking features?",
    o: [
      "A. Update Industries Settings to give users access to the Commercial Banking Console Lightning app.",
      "B. Assign permission sets to give users access to the Commercial Banking Console Lightning app.",
      "C. Update theuser profiles to give users access to Financial Services Cloud objects",
      "D. Install the Commercial Banking Managed Package",
    ],
    a: ["B"],
  },
  {
    i: 22,
    q: "Cumulus Insurance has created a Delegated Administrator group for its franchise users to reduce the workload on head office support staff.\nWhich three functions should be added to the Delegated Administrator group?",
    o: [
      "A. Unlock users.",
  ...
  {
    i: 23,
    q: "Cumulus Bank has branches in multiple countries that are required to report in local currency, while the corporate headquarters office wishes to see reports in a single currency (the corporate currency).\nWhich solution should a consultant recommend to meet these requirements?",
    o: [
      "A. Set the default currency for head office and have the regions download their reports to Excel and convert them manually.",
      ...
      "D. Allow users to set their preferred currency in their profile and design reports that convert currencies for the user running the report.",
    ],
    a: ["C"],
  },
  {
    i: 24,
    q: "A financial services company needs a custom field for reporting when relating two-person accounts to each other. Which object should the Financial Services Cloud consultant configure the custom field on?",
    o: [
  ...
  {
    i: 25,
    q: "An investment bank is implementing Financial Services Cloud (FSC) to manage the deal pipeline. Each opportunity has confidential information that the deal team members must only view.\nIn addition, each member needs the ability to take and share notes directly within Salesforce with others on the team.\nWhich three FSC features should be part of the solution design?",
    o: [
  ...
  {
    i: 26,
    q: "Omni Script represents processes with fast, personalized, and consistent responses. This type extends the metadata type and inherits its full name field. To use the Omni Script metadata type, what should the administrator enable in the Salesforce org?",
    o: [
  ...
  {
    i: 27,
    q: "A consultant is configuring a demo for a customer but cannot create new residential loan application records.\nWhat is prohibiting the consultant from creating a new residential loan application?",
    o: [
  ...
  {
    i: 28,
    q: "How should developers configure customized nodes for display in ARC?",
    o: [
  ...
  {
    i: 29,
    q: "A financial services company wants to track different categories of financial accounts in its org. Relationship managers must be able to see all of these financial accounts in one place on the customer's Account record page grouped by categories.\nWhich three steps should an administrator take to configure the Financial Account object and the Account Lightning record page to meet the design?",
    o: [
      "A. Add the Financial Account List component to the Account Lightning record page.",
      "B. Configure the Financial Account List components for each required category.",
      "C. Create Account lookup fields on the Financial Account object to link the Financial Accounts to an Account.",
      "D. Create a custom picklist on the Financial Account object totrack the Typ",
      "E. Configure Financial Account record types to match the required categories.",
    ],
    a: ["B", "C", "D"],
  },
  {
    i: 30,
    q: "A financial institution has custom security and visibility rules where certain users need to see specific records even though they are not typically engaged in that Account. This includes legal and compliance members who must be engaged for particular deals.\nWhich Financial Services Cloud capability provides the ability to accommodate this request?",
    o: [
  ...
  {
    i: 31,
    q: "Which setting in Action Plans helps to avoid non working hours, company holidays, and other non working days for deadline calculation?",
    o: [
      "A. Sync with Company Calendar",
      "B. Skip Non-Work Days for Deadlines",
      "C. Skip Non-Work Days For Tasks",
      "D. Skip Non-Work Days for Action Plans",
    ],
    a: ["B"],
  },
  {
    i: 32,
    q: "A new custom object has been created, and the records of this object will be created through integration with another system What should a consultant do to ensure the data is loading into the correct fields in Financial Services Cloud?",
    o: [
  ...
  {
    i: 34,
    q: "The Salesforce Admin of Lake Tahoe Bank wants to implement Financial Services Cloud using the individual object model. What are the steps to disable person accounts? (Choose Three)",
    o: [
  ...
  {
    i: 35,
    q: "Scott Adams is opening a joint savings account with his mom, Rachel Adams. Rachel Adams is the primary member of the Adams Household. Personal Banker Hank Burton wants to make sure that Scott's data is rolling up to the Adams Household. How can the Banker accomplish this?",
    o: [
      "A. Make the Adams Household Scott's primary Group and edit tie Activities & Objects to ft* Up.",
      "B. Add Scott’s as a Related Contact to the Adams Household.",
      "C. Make the Adams Household Scotts Primary Group and make Scott the Primary member",
      "D. Disable the Primary Group setting for Scott on the Adams Household",
    ],
    a: ["A"],
  },
  {
    i: 36,
    q: "Lake Tahoe Bank is rolling out Financial Services Cloud and the VP of IT is concerned about the cost of the licenses. The System Admin recommends using restricted licenses for users that need only limited access to Financial Service Cloud features. Which Financial Services Cloud permission set license enables user access to a license with contractual restrictions for Financial Services Cloud and\ncan be used to grant restricted access to users like Bank Tellers?",
    o: [
  ...
  {
    i: 37,
    q: "Cumulus Cloud Bank needs help onboarding new customers. The business process requires updating the Know Your Customer (KYC) document checklist and performing internal tasks in a predefined order.\nHowever, during an internal audit, it was found that bankers often miss these tasks and still move to the next stage of the onboarding process.\nWhat should a consultant recommend?",
    o: [
  ...
  {
    i: 38,
    q: "A consultant advising Cumulus Bank wants to ensure that the bank is compliant with Identity Verification Regulations when customers contact the bank.\nWhich two features should a consultant leverage to design this business process?",
    o: [
      "A. Omni Studio",
      "B. Process Builder",
  ...
  {
    i: 39,
    q: "Which three processes are part of Claims Management?",
    o: [
      "A. Auto Adjudication",
  ...
  },
  {
    ...
    o: [
      ...
      "D. Create and assign the Custom Field Set permission set to all users.",
  ...
  {
    i: 41,
    q: "Cumulus Insurance has a franchise business model with a large number of franchisees who operate independently but report to regional managers who are Cumulus employees. The company would like the franchise owners and their employees to have access to the Cumulus Salesforce Financial Services Cloud (FSC) instance. The company plans to use the Role Hierarchy and sharing\nrules to implement this. What should the architect at Cumulus Insurance be aware of for this solution?",
    o: [
  ...
  {
    i: 42,
    q: "It has been determined that integration with an external system is required, as the data needed by a wealth management client resides in another system. This data will be sent from the external system via an API, and Salesforce needs to be configured in preparation for the data.\nWhich two items should be configured?",
    o: [
  ...
  {
    i: 43,
    q: "In Financial Services Cloud, what is the criteria for commas and symbols to be displayed correctly on the Financial Account Summary component?",
    o: [
      "A. User currency must match org default currency.",
      "B. Account currency must match org default currency.",
  ...
  {
    i: 44,
    q: "A wealthy client owns a boutique shoe store called Smith's Shoes. Their financial advisor would like to add this relationship to the Financial Services Cloud (FSC) to track the complete picture of relationships related to the wealthy client's household.\nWhich three options should the Financial Services Cloud consultant use when mapping this relationship in FSC?",
    o: [
  ...
  {
    i: 45,
    q: "A financial services company needs to capture a new type of referral that has different required fields than what is currently configured inthe org.\nWhich three steps should the administrator take to configure Financial Services Cloud correctly based on the scenario?",
    o: [
  ...
  {
    i: 46,
    q: "A financial institution is concerned about contacting clients or sharing their data when they have requested not to be contacted.\nWhich action should the consultant take in Financial Services Cloud to address the\ninstitution's concern?",
    o: [
      "A. Integrate the Consent object with their Consent Platform to track it in Salesforce.",
      "B. Hide the client's contact information and add an approval process for allowing a user to access it to contact the client.",
      "C. Implement Consent Management for Financial Services Cloud.",
      "D. Enable and implement the appropriate Regulation checkbox on the client record to track their request.",
    ],
    a: ["C"],
  },
  {
    i: 47,
    q: "Which three related lists are visible within Actionable Relationship Center associated with the Account object?",
    o: [
      "A. Cases",
      "B. Financial Holdings",
      "C. Household Financial Accounts",
  ...
  },
  {
    ...
    o: [
      ...
      'C. When an account status is changed to "Customer” create an action plan with tasks to follow up in 2 days. 2 weeks, and 2 months.',
  ...
  {
    i: 51,
    q: "A wealth management firm is looking to start tracking its clients' hobbies for marketing purposes in Salesforce. Which Financial Services Cloud feature is most suitable for this?",
    o: ["A. Interest Tags", "B. Alerts", "C. Topics", "D. Engagement Topics"],
    a: ["A"],
  },
  {
    i: 52,
  ...
  {
    i: 53,
    q: "Which three record type options should an advisor configure for a Lead object configuration?",
    o: [
      "A. Referral",
      "B. Opportunity",
      "C. General",
  ...
  {
    i: 54,
    q: "The Salesforce Administrator at Lake Tahoe Bank is asked at make modifications to the Salesforce org to allow for more than one people being joint owners on a Financial Account. What will be the recommended approach to model this requirement?",
    o: [
  ...
  {
    i: 55,
    q: "A financial services company would like its users to be able to relate two business accounts.\nWhat should the administrator configure to meet the requirement?",
    o: [
  ...
  {
    i: 56,
    q: "Which three standard fields are available to track a customer's retirement gial progress?",
    o: [
      "A. Contributions",
      "B. Actual value",
      "C. Total Value",
  ...
  {
    i: 57,
    q: "What 2 considerations should the Salesforce Administrator review before implementing Flow for customer onboarding?",
    o: [
      "A. Use Field Level Security on Milestones",
      "B. Flow for Financial Service Cloud is not available for the Individual Object Model.",
      "C. Flow Screen Input Components can only be used in Financial Service Cloud Flow Templates",
      "D. The Flow users require a Flow Permission Set License.",
    ],
    a: ["A", "B"],
  },
  {
    i: 58,
    q: "Jen, the Financial Advisor at Lake Tahoe Wealth Management Company wants to modify a published Action Plan to support an additional task she needs in order to complete an annual review for a client. How should Jen do this?",
    o: [
  ...
  {
    i: 59,
    q: "The investor relations director of a large insurance company just published a press release after the company's Quarterly Earnings Call to report about its digital transformation implementing Salesforce Financial Services Cloud (FSC).\nWhich three value outcomes should the company's stakeholders expect?",
    o: [
      ...
      "D. Drove Advisor productivity with a daily task list, client life events, opportunities, and aggregated household information directly from D the FSC HomeT\\e",
      "E. Automated claims orchestration via straight through processing workflow rules from Omni Studio with minimal human intervention from insurance adjusters or underwriters, allowing claims to be completed faster and at scale",
    ],
    a: ["A", "C", "D"],
  },
  {
    i: 60,
    q: "A consulting firm is asked to add Events and Milestones to a Lightning record page to give financial advisors deeper insights into their customers' lives.\nWhat should the consultant configure to enable advisors to capture Once-in-a-Lifetime events and, at the same time, prevent users from accidentally creating more than one event of such an event type?",
    o: [
  ...
  {
    i: 61,
    q: "Which Salesforce Financial Services Cloud feature enables financial advisors to track and manage client accounts?",
    o: [
  ...
  {
    i: 64,
    q: "Cumulus Bank has implemented Compliant Data Sharing in Financial Services Cloud. Which two things happen when an opportunity record that has opportunity participants with associated share table entries is set to Private?",
    o: [
  ...
  {
    i: 65,
    q: "A consultant is building an agent console for an insurance company using Flex Cards to provide a 360-degree view of its customers. An Integration Procedure will be used to retrieve Account, Opportunity, and Contract data. The agent wants the following information displayed:\n* Account information including account name, phone, and website\n* Active opportunities related to the Account\n* Active insurance policies related to the Account\n* The ability to view and renew policies\nHow should the consultant design the Flex Cards to meet these requirements?",
    o: [
      "A. Parent Flex Card with single Child and Card Actions",
      "B. Parent Flex Card with multiple child Flex Cards and Card Actions",
      "C. Parent Flex Card with multiple children and different Card States",
      "D. Parent Flex Card with single Child and multiple Card States",
    ],
    a: ["B"],
  },
  {
    i: 66,
    q: "Which two statements are true about Group Membership in Financial Services Cloud?",
    o: [
  ...
  {
    i: 67,
    q: "Cumulus Cloud Bank is asking the consultant to explain some tools available to integrate Salesforce into several of its back-end/core systems.\nWhich three capabilities should a consultant recommend?",
    o: [
      "A. Industry Integration Solutions with the MuleSoft Any point Platform",
      "B. Data Processing Engine",
      "C. Omni Studio Integration Procedures",
      "D. Data Consumption Framework",
      "E. Omni Studio DataRaptors",
    ],
    a: ["A", "C", "E"],
  },
  {
    i: 68,
    q: "What are the three building blocks of Flow Orchestration?",
    o: ["A. Steps", "B. Blocks", "C. Stages", "D. Processes", "E. Work Items"],
    a: ["A", "C", "E"],
  },
  {
    i: 69,
    q: "How are identification documents, other assets, liabilities, goals, and revenue modeled, in an existing Financial Services Cloud org using the individual account model?",
    o: [
      ...
      "C. Custom objects are used to represent other assets, liabilities, and goals. In the individual model, these objects are related to the Account object.",
  ...
  {
    i: 70,
    q: "Which three permission sets grant access or extend permissions for record alerts in Financial Services Cloud (FSC)?",
    o: [
      "A. Omni Studio Admin permission set",
      "B. FSC Standard permission set",
      "C. FSC Foundations permission set",
      "D. FSC Basic permission set",
      "E. Omni Studio User permission set",
    ],
    a: ["B", "C", "E"],
  },
  {
    i: 71,
    q: "A banking client currently manages its onboarding process manually with paper forms. To optimize the process, the client wants to digitize and automate as much as possible. The bank wants its clients to manage the forms in a portal and leverage e-signatures for processing.\nWhich three steps are needed to document this requirement following the discovery session?",
    o: [
      ...
      "D. Understand the journey the multiple personas involved in the process.",
      "E. Determine the best e-signature solution to use.",
    ],
    a: ["A", "D", "E"],
  },
  {
    i: 72,
    q: "Lake Tahoe Bank would like to capture their commercial customers in FSC. A commercial customer can be owned by multiple groups. How can Lake Tahoe Bank SF Admin configure FSC to capture and display commercial customer and its parent company ? (3 correct answers)",
    o: [
  ...
  {
    i: 73,
    q: "When importing records from a system outside of Salesforce, which ID should be used to prevent the data import from creating duplicates?",
    o: ["A. User ID", "B. Data Load ID", "C. External ID", "D. Org ID"],
    a: ["C"],
  },
  {
    i: 74,
    q: "A Financial Services Cloud (FSC) administrator is setting up a permission set for Actionable Relationship Center. Which license should the administrator select on the Permission Set setup page?",
    o: [
      "A. FSC Standard",
      "B. FSC Basic",
      "C. Omni Studio",
  ...
  {
    i: 75,
    q: "During a project's design phase, a consultant must provide a Financial Services Cloud solution that can support Compliant Data Sharing (CDS). What are three things the consultant should consider regarding CDS?",
    o: [
  ...
  {
    i: 77,
    q: "Lake Tahoe Bank branch manager Sue Barry wants to encourage all Personal Bankers to use Action Plans to capture repeatable tasks and automate the task sequences, improving collaboration and productivity. Which three of the following statements about Action Plans are true?",
    o: [
  ...
  {
    i: 78,
    q: "Our Personal Banker Hank Burton is learning to use Action Plans to ensure compliance in the client onboarding process. Where can Hank see Action Plan Tasks? (2 options)",
    o: [
  ...
  {
    i: 79,
    q: "If a client is associated with more than one Household or Group, where will this clients records get rolled up to?",
    o: [
      "A. to the household with the client's primary address",
      "B. to all the parent households and groups",
      "C. to the household selected by the advisor for record rollups.",
      "D. to the Household where the client is the primary member",
    ],
    a: ["C"],
  },
  {
    i: 80,
    q: "What capability included in the Financial Services Cloud license can assist bankers in focusing on the most promising referrals?",
    o: [
  ...
  {
    i: 81,
    q: "Personal Banker Hank Burton is questioning his Referral Score shown in Salesforce Financial Services Cloud.\nWhen is the Referral Score updated?",
    o: [
  ...
  {
    i: 82,
    q: "A client has called their Financial Advisor to open an Education Savings Account for their first child. What 2 steps should the Financial Advisor take in the Financial Services Cloud App to capture that information?",
    o: [
  ...
  {
    i: 83,
    q: "A wealth advisor is trying to relate a client to their attorney using the Add Contact option on the relationship tree but can't find any reciprocal roles displayed in the related role lookup. What are two reasons for this?",
    o: [
      "A. The user should be using the Member Relationship button under the Actionable Relationship Center.",
      "B. Reciprocal roles have not been created in the org.",
      "C. Sharing rules have not been set up for reciprocal roles.",
  ...
  {
    i: 84,
    q: "Lake Tahoe Bank, an existing Salesforce customer, is planning to implement Financial Services Cloud. Their Salesforce Admin is considering whether to use a new Salesforce org or upgrade the existing org. Which three of the considerations below indicate that a new Salesforce org is the better choice?",
    o: [
  ...
  {
    i: 85,
    q: "A financial services company wants to use the Financial Services Cloud Person Account data model. The company needs two Person Account record types, one to represent Individual customer and one to represent Individual independent advisors that send referrals.\nWhat should the administrator do to set up the new record types?",
    o: [
  ...
  {
    i: 86,
    q: "For which three objects are Rollup By Lookup (RBL) summaries are available?",
    o: [
      "A. Life Events",
  ...
  {
    i: 87,
    q: "How can the Salesforce Administrator make sure that highly sensitive Life Events or Business Milestones will not be shown until the event actually happened?",
    o: [
      ...
      "C. Remove the Event or Milestone from the Lightning Component in the Developer Console.",
      "D. Life Events are part of the FSC managed package, therefore the Salesforce Admin must contact Salesforce Support to remove the Event from the Lightning Component.",
    ],
    a: ["A"],
  },
  {
    i: 88,
    q: "Lake Tahoe Bank allows more than two owners on Financial Accounts. The Salesforce Admin wants to make sure that balances are rolled up to all joint owner's primary Households. Which 2 options does the Salesforce Admin have to accomplish this?",
    o: [
  ...
  {
    i: 90,
    q: "The Salesforce Administrator for Lake Tahoe Bank is receiving a report that a members Financial Account Balances are not adding up to the Financial Summary field in the related Household.\nWhich two steps should the admin take to troubleshoot the issue?",
    o: [
      "A. Ensure the Primary Group flag in the Account record is checked.",
      "B. Ensure Roll Up By Lookup Configuration is Active",
      "C. Ensure a Roll Up By Lookup batch job is scheduled to run every 15 mins.",
  ...
  {
    i: 91,
    q: "The Salesforce Admin at Lake Tahoe Bank is implementing Financial Services Cloud and wants to roll up customer data at the client and group levels. What functionality can Rollup By Lookup (RBL) provide for this requirement?",
    o: [
  ...
  {
    i: 92,
    q: "Where should a Salesforce Administrator go to add custom icons to the Life Events and Business Milestones?",
    o: [
      "A. Lightning Page Layout > Life Events and Business Milestones Lightning Component > Page Icon Properties",
      "B. Setup > Custom Code > Static Resources",
      "C. Setup > User Interface > icons > Life Events and Business Milestones",
      "D. Setup > Financial Services > Icons > Life Events and Business Milestones",
    ],
    a: ["B"],
  },
  {
  ...
  {
    i: 94,
    q: "To access all Financial Services Cloud (FSC) functionalities available out of the box, a consultant must install the FSC Managed Package and the Unmanaged Extension Packages.\nWhich two functionalities are included in the FSC Unmanaged Extension Packages?",
    o: [
  ...
  {
    i: 95,
    q: "Permission set licenses incrementally entitle users to access features that are not included in their user licenses.\nWhich three Permission Set Licenses give users access to Financial Services Cloud features?",
    o: [
      "A. Financial Services Cloud Standard",
      "B. Action Plans",
  ...
  {
    i: 96,
    q: "Lake Tahoe Bank has branch offices in many countries around the world and they are planning to roll out Financial Services Cloud. Which of the 2 considerations does the Salesforce Admin have to keep in mind when it comes to dealing with multiple currencies?",
    o: [
      "A. For each user, the user currency must correspond to the default currency for the user's locale",
  ...
  {
    i: 97,
    q: "Cumulus Cloud Bank must provide its customer service staff with real-time access to\nCustomer accounts, including the ability to view current transactions and balances. As a result, the bank expects a high volume of concurrent users at peak times.\nWhich option is most suitable?",
    o: [
      "A. Use the Data Consumption Framework to connect to the bank's middleware.",
      "B. Use Salesforce Connect with External Objects to expose tables from the bank's core systems, and use custom Lightning web components to surface them in the Salesforce Lightning Ul.",
      "C. Use Salesforce Connect with External Objects to expose tables from the bank's core systems, and use the standard user interface (Ul) components to surface the records in Salesforce Lightning Ul.",
      "D. Embed custom Lightning web components on the Account and Financial Account pages, and use custom Apex to make callouts to the core system services.",
    ],
    a: ["D"],
  },
  {
    i: 98,
    q: "A commercial loan due diligence process is handled by multiple individuals at Lake Tahoe Bank. Lake Tahoe Bank wants an easy way for managers to distribute the work, to understand the completion of the due diligence process per client and report on the performance of the department to show possible bottlenecks.\nWhat FSC feature can Lake Tahoe Bank use to track this process?",
    o: [
      "A. Workflow Rules/Process Builder",
      "B. Action Plans",
      "C. Apex Triggers on the task object",
      "D. Flows",
    ],
    a: ["B"],
  },
  {
    i: 99,
    q: "A Salesforce administrator updating a record page to add a Chatter component to the Action Plan Lightning record page is unable to find the Chatter components for selection.\nWhat is the reason for this?",
    o: [
  ...
  {
    i: 100,
    q: "A large insurance company hired a consulting firm to improve customer experiences for customers that want to complete standard processes online, such as getting an insurance quote or submitting a claim.\nWhich three standard Insurance Platform components can digitally enable these core insurance operations?",
    o: [
      "A. Policy Administration",
      "B. Claims Management",
      "C. Quote, Rate, and Apply",
      "D. Quote Creation Toolbox",
      "E. Mobile Claim Submission",
    ],
    a: ["A", "B", "C"],
  },
  {
    i: 101,
    q: "Our Personal Banker Hank Burton wants to encourage his customers to provide required documents for a loan application. He creates Document Checklist Items that help his customers to manage file uploads to speed up loan approval. For which of the following records does Salesforce support Document Checklist Items out of the box? (Choose Three)",
    o: [
      "A. Contact",
      "B. Lead",
      "C. Account",
  ...
  {
    i: 102,
    q: "A financial services company is migrating a legacy customer relationship management system to Financial Services Cloud (FSC). The company is requesting that its consulting partner introduce specific customer interaction features mapped to its business processes.\nWhat should the consultant consider when introducing the FSC features?",
    o: [
      "A. If there is a business process for tracking the customer life events and milestones, and timely reminding of opportunities, the Action Plan component is recommended to use.",
      "B. If there is a business process for limiting role-based data visibility, the Interaction Summaries component is recommended to use.",
      "C. If there is a business process for taking detailed notes for client meetings and adding action items, the Action Plan component is recommended to use.",
      "D. If there is a business process for showing common interests and needs across the company's clients, the Interaction Summaries component is recommended to use.",
    ],
    a: ["C"],
  },
  {
    i: 103,
    q: 'To access Financial Services Cloud Lightning Components "My Domain" must be enabled.\nHow does the System Admin accomplish this?',
    o: [
      "A. Register a subdomain using the My Domain wizard and then deploy it",
  ...
  {
    i: 104,
    q: "What feature does a Salesforce Administrator need to enable so users can see all the referrals for the members of a group?",
    o: [
      "A. Referral Scoring",
      "B. Referrals Rollups",
  ...
  {
    i: 109,
    q: "Which 3 out of the box capabilities come with Financial Services Cloud Lead & Referral Management?",
    o: [
  ...
  {
    i: 110,
    q: "A bank needs help with many of its processes taking too long to complete. Many of its challenges are due to issues with handoffs between teams. The challenges also include users transferring control to the wrong person or team or forgetting to transfer it at all.\nWhich two Financial Services Cloud capabilities should help address these challenges?",
    o: [
      "A. Action Plans",
      "B. Financial Accounts",
      "C. Omni Scripts",
  ...
  {
    i: 113,
    q: "Which three of the following statements are correct about the Actionable Relationship Center Manager (ARC)?",
    o: [
  ...
  {
    i: 114,
    q: "A consultant is working with a new customer and has gained a firm understanding of their business processes and systems in preparation for implementing Salesforce Financial Services Cloud.\nWhat should the consultant create as a deliverable for the current state business process?",
    o: [
  ...
  {
    i: 116,
    q: "Scott Adams calls his Personal Banker Hank Burton to apply for a loan to buy a boat. Hanks wants to refer Scott to the loan department, but the current process is manual and time-consuming.\nHank is asking the bank's System Administrator to automate Referral creation in Salesforce. How can the Admin speed up and simplify Referral creation?",
    o: [
      "A. Write a trigger to create Referrals from a 'Create Referral* button.",
      "B. Use the Case process and create Cases with Case Type 'Referral'.",
      "C. Use Global Action To create Referrals.",
      "D. Use",
    ],
    a: ["C"],
  },
  {
    i: 117,
    q: "Lake Tahoe Bank is migrating customer records from the Individual Model to Person\nAccounts. Which three steps should a Data Architect take to ensure a successful migration?",
    o: [
      "A. Ensure Person Accounts is enabled on the org",
      "B. Configure your Person Account record types m the individual Record Type Mapper.",
      "C. Enable 'Individual to Person Account Migration' in Custom Settings.",
      "D. Use a CSV field to map PersonRecordTypeld to the Person Account RecordTypeld and use Data Loader to update Client Records",
      "E. Log a case with Salesforce to perform the conversion from the individual Model to Person Accounts.",
    ],
    a: ["A", "B", "D"],
  },
  {
    i: 118,
    q: "Which step is required to give a group of users access to a Financial Deal?",
    o: [
      ...
      "C. Share a financial deal record with a group by adding them as participants to the record from the Financial Deal Participants related list,",
  ...
  {
    i: 119,
    q: "Which three insurance processes are managed by the Policy Administration component?",
    o: [
      "A. Payments",
      "B. Approvals",
      "C. Commissions",
  ...
  {
    i: 121,
    q: "How should developers configure customized nodes for display in the Actionable\nRelationship Center (ARC)?",
    o: [
  ...
  {
    i: 122,
    q: "Lake Tahoe Bank is implementing Financial Services Cloud. The bank's new business processes require that Financial Advisors can add individuals to more than one Group or Household using Multiple Relationship Groups. Where do Admins enable Multiple Relationship Groups?",
    o: [
      "A. Object Settings",
      "B. Custom Settings",
  ...
  {
    i: 123,
    q: "An investment bank client wants all its users to track client engagements with Interaction Summaries. In addition, those call logs need to be shared with specialists in other lines of business so they can assist in specific types of deals.\nWhich three Financial Services Cloud standard objects should be used to help accommodate these business requirements?",
    o: [
  ...
  {
    i: 125,
    q: "An insurance company needs to ensure the record rollups aggregate information from related records for several objects in the Financial Services Cloud at a client or group level.\nWhat should the administrator configure to meet the requirement?",
    o: [
  ...
  {
    i: 126,
    q: "A Bank of the Future customer calls the bank to update the address on their account. The call center agent handling the call needs to enter a new address into the system. The agent enters the new contact information using an Omni Script and then needs to generate a prefilled PDF with the new address that can be shared with the customer.\nWhich two Omni Studio tools should a consultant recommend to generate the prefilled PDF?",
    o: [
      "A. Omni Studio Action Document Generation",
  ...
  {
    i: 127,
    q: "Which three objects should a Financial Services Cloud administrator use when planning to use the Mortgage Data Model to integrate with external Loan Origination and Customer Onboarding applications to accurately track the pipeline?",
    o: [
  ...
  {
    i: 128,
    q: "An asset management firm that is moving to Salesforce from its old CRM wants to be able to bring over its client data on drivers' licenses and passports. 55m 058 Which Financial Services Cloud object should a consultant recommend?",
    o: [
  ...
  {
    i: 129,
    q: "The Salesforce Admin of Lake Tahoe Wealth Management Company needs to update an existing, published Action Plan Template to accommodate a change in the firm's annual client review process. What steps should the Admin take to make that change?",
    o: [
  ...
  {
    i: 130,
    q: "What benefits do Flows for Financial Services Cloud offer to support customer onboarding? (Choose Two)",
    o: [
  ...
  {
    i: 131,
    q: "Which three related lists are visible within the Actionable Relationship Center associated with the Account object?",
    o: [
  ...
  {
    i: 134,
    q: "The Compliant Data Sharing (CDS) feature lets administrators and compliance managers configure advanced data-sharing rules so that they can improve compliance with regulations and company policies.\nWhich three things should be considered when implementing CDS in Financial Services Cloud (FSC)?",
    o: [
      "A. To disable CDS for an object, any Participant Roles associated with that object must be deleted first.",
      ...
      "D. To get the benefits of CDS, administrators must set organization-wide sharing settings for supported objects to the Private access model.",
      "E. Users above the record owner in the Role Hierarchy and non-record owners with Edit access granted through CDS have the same ability/access as record owners,",
    ],
    a: ["B", "C", "D"],
  },
  {
  ...
  {
    i: 136,
    q: "How can the Salesforce Admin change the configuration to summarize Financial Goals at the household level?",
    o: [
      "A. Add a custom Rollup By Lookup (RBL) rule.",
      "B. Financial Goal scan not be summarized at the household level.",
      "C. Create a formula field and add it to the Account page layout",
      "D. Update the selection in \"Activities & Objects to Roll Up' to include Financial Goals",
    ],
    a: ["D"],
  },
  {
    i: 137,
    q: "During the design phase of a project, a consultant needs to provide a Financial Services Cloud (FSC) solution for a business requirement that forces a customer to answer a number of assessment questions to complete the onboarding process.\nWhat are three things to consider regarding Discovery Framework?",
    o: [
  ...
  {
    i: 138,
    q: "A financial services company needs to add new values for how a customer can be related to a financial account. Which object/field should the administrator add new values on?",
    o: [
      "A. Object: Financial Account Role; Field: Role",
  ...
  {
    i: 140,
    q: "A financial services company has found that more than two-thirds of customer onboarding processes are manually done by client specialists, consuming large amounts of time and resulting in errors in the sales process. The company contacts a consultant to learn how to leverage Financial Services Cloud features to improve the current state.\nWhat should the consultant consider from a customer onboarding perspective?",
    o: [
      "A. If the company struggles with the low efficiency of collecting data in questionnaires and meeting compliance with the company policies. Action Plan can be used to improve the current state.",
      "B. If the company struggles with the low efficiency of tracking required documents for its customers and creating templates for checklists. Discovery Framework is recommended to improve the current state.",
      "C. If the company struggles with the low efficiency of tracking required documents for its customers and creating templates for checklists, Action Plan is recommended to improve the current state.",
  ...
  {
    i: 141,
    q: "Cumulus Bank is migrating its CRM software from a legacy application to Salesforce Financial Services Cloud (FSC). The bank hired Salesforce Professional Services to configure/deploy the new Salesforce FSC org and migrate data.\nWhich order should a consultant follow when performing the data migrations?",
    o: [
      ...
      "D. Financial Accounts, then Financial Account Transactions, then Financial Account Roles, then Individuals",
    ],
    a: ["B"],
  },
  {
    i: 142,
    q: "Which three referral metrics are tracked with custom components included in Financial Services Cloud?",
    o: [
  ...
  {
    i: 143,
    q: "A company wants to convert its Salesforce Financial Services Cloud implementation from using the individual account model to using person accounts.\nWhich three things should a consultant do to prepare for the conversion?",
    o: [
  ...
  {
    i: 144,
    q: 'Rachel is the primary member of the Adams household hired a new attorney. What type of relationship should the Wealth Advisor create in Financial Services Cloud for Rachel and her attorney before assigning the reciprocal role of "Attorney"?',
    o: [
      "A. Create an Account-Contact relationship between the Adams Household and the attorney.",
      "B. Create an Account-Account relationship between the Adams Household and the attorney",
      "C. Create a Contact-Contact Relationships between the primary member of the Adams Household and the attorney.",
      "D. Create an Account-Account Relationship between the Addams Family Trust and the attorney.",
    ],
    a: ["C"],
  },
  {
    i: 145,
    q: "Lake Tahoe Bank wants their customer reps to be able to see client records such as Person Accounts, but want to restrict access to Financial Accounts to protect the privacy of their clients.\nWhich two steps can an admin take to ensure that all users see Person Accounts, but only specific users can view Financial Accounts?",
    o: [
  ...
  },
  {
    ...
    o: [
      ...
      "D. Create a Financial Account sharing rule based on criteria",
    ],
    a: ["D"],
  },
  {
    i: 148,
    q: "Which of the following objects do support Group-Level Rollups?",
    o: [
      "A. Tasks",
      "B. Alerts",
  ...
  {
    i: 149,
    q: "Lake Tahoe Bank would like to reslricl their Financial Services Cloud users from viewing certain types of milestones that might be irrelevant to their customersor might cause negative sentiment. How can the Salesforce Admin implement such a requirement?",
    o: [
  ...
  {
    i: 151,
    q: "A financial services company needs to alert advisors about changes in client records that require action. What should the administrator consider when configuring Record Alerts?",
    o: [
      ...
      "B. When the admin creates a value for the Severity field, the warning icon is associated with the field automatically, and advisors cannot change the icon.",
  ...
  {
    i: 152,
    q: "The Salesforce Admin at Lake Tahoe Bank considering implementing Financial Services Cloud. What is the best way for the Admin to access a Financial Services pre-configured org, including data and the right licenses, to learn about the product?",
    o: [
  ...
  {
    i: 153,
    q: "Salesforce provides a robust set of automation features to help save time and resources. For example, a system administrator can use Flow Builder to automate most of an organization's repetitive business processes.\nWhich use case is a suitable fit for Flow Builder?",
    o: [
      ...
      "C. Collect input from internal users with a form placed on a Lightning page launched by a button.",
  ...
  {
    i: 154,
    q: "A financial services company must add details to the default business hours record. For company-wide holidays, the company wants the option to skip non-work days in Action Plan when setting task completion dates.\nWhat should the administrator configure to meet the requirement?",
    o: [
  ...
  {
    i: 155,
    q: "Which three types of preassembled flows can be utilized from the Financial Services Cloud (FSC) packages and the Lightning Flow for FSC package?",
    o: [
  ...
  {
    i: 156,
    q: "The Actionable Relationship Center (ARC) is using the Association Type picklist to control the account- account relationships. Which three of the following names are Association Type picklist field values?",
    o: ["A. Member", "B. Group", "C. Trust", "D. Family", "E. Peer"],
    a: ["C", "D", "E"],
  },
  {
    i: 157,
    q: "An investment banker is looking to take detailed meeting notes and share them easily with his colleagues while specifying confidentiality and meeting attendees. Which Financial Services Cloud feature should a consultant recommend in this scenario?",
    o: [
      "A. Notes",
      "B. Events",
  ...
  {
    i: 158,
    q: "What steps does the Salesforce Administrator have to take to create a new Business\nMilestone Type?",
    o: [
      "A. In the Object Manager go to the Business Milestone object and create a new field using the name of the new milestone.",
      "B. Find Person Life Event using the Object Manager and add a new picklist value on the Milestone Type Field.",
      "C. Find Business Milestone using the Object Manager and add a new picklist value on the Milestone Type Field",
      "D. In the Lightning Page Editor add the new Milestone Type to the Life Events & Business Milestones Lightning component",
    ],
    a: ["C"],
  },
  {
    i: 159,
    q: "An insurance company wants to create a car insurance quote process for its website. The process should include the following functionality:\n* The user has to enter contact and address information.\n* The user has to enter the driver's age and the car model and year.\n* The process should calculate an insurance quote based on the data the customer provided and save the offer to the client's record.\nWhich three Omni Studio tools should the consultant use to design a solution that meets these requirements?",
    o: [
      "A. Omni Scripts",
  ...
  {
    i: 161,
    q: "Lake Tahoe Bank's financial advisors are complaining that they can't see an accurate summary of their clients financial data as clients often change households. How can an Admin set up Financial Services Cloud to provide financial advisorswith an accurate summary of their client's financial data?",
    o: [
      ...
      "C. Create a custom object to track client's financial data",
  ...
  {
    i: 164,
    q: "Cumulus Bank's mortgage department is currently using spreadsheets to gather client data for mortgage applications. The bank is interested in improving the efficiency of this process.\nWhich two features should a consultant suggest to Cumulus Bank to implement?",
    o: [
  ...
  {
    i: 165,
    q: "A financial services company needs a custom field for reporting when relating two business accounts to each other. Which object should the administrator configure the custom field on?",
    o: [
      "A. Contact-Contact Relationship",
      "B. Account",
  ...
  {
    i: 166,
    q: "Which three things must an admin keep in mind when creating Action Plan Templates'5",
    o: [
      ...
      'D. When youcreate an Action Plan from a template for a specific target record, item deadlines are calculated using the start date and date offset " defined in the Action Plan Template',
  ...
  {
    i: 167,
    q: "A System Administrator has received a note from one of the portfolio managers that the Actionable Relationship Center (ARC) is not visible when the portfolio manager was trying to set up relationships between two accounts. The portfolio manager has also mentioned that other colleagues in the same role have access to it and are able to use it to manage their customer's relationships. What is a possible cause for this?",
    o: [
  ...
  {
    i: 168,
    q: "Which three types of Account-Account relationships are displayed in the Actionable\nRelationship Center?",
    o: [
  ...
  {
    i: 170,
    q: "Which 3 options does the Financial Services Cloud application offer to view and update Account-Account.\nAccount-Contact, and Contact-Contact Relationships?",
    o: [
  ...
  {
    i: 171,
    q: "Lake Tahoe Bank branch manager is asking the Salesforce Administrator for improvements in Salesforce to speed up Loan Approval Processing. The Salesforce Admin is considering using Action Plans. Which 3 process improvements can be delivered using Action Plans?",
    o: [
      "A. Action Plans create repeatable tasks and automate the task sequences when executed",
      'B. When you create an action plan from a template for a specific targetrecord, items that have no assigned user are assigned to the owner of that " target record.',
  ...
  {
    i: 172,
    q: "What should a Financial Advisor use to model the relationship between a business contact and a client that is modeled as a person account?",
    o: [
